  ...
  <div className="bg-card border border-border rounded-lg p-8 leading-relaxed panel-glow">
    ...
    <Section title="4. Análise Gkeka-Serpetsidaki et al. (2022)">
      ...
      <DocCard>
        ...
        <Equation>
          <SubVar symbol="O" sub="H" /><Op>&lt;</Op><Row><Num>0,6</Num><Text> m</Text></Row><Op>;</Op><SubVar symbol="O" sub="A" /><Op>&lt;</Op><Row><Num>0,0025</Num><Text> m</Text><Sup base={<Text />} exp={<Num>2</Num>} /></Row>
        </Equation>
        <p className="text-xs text-muted-foreground mt-3">
...
const Fn = ({ children }: { children: ReactNode }) => <mi>{children}</mi>;
